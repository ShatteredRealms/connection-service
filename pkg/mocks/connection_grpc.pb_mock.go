...
// Source: /home/wil/dev/sro/connection-service/pkg/pb/connection_grpc.pb.go
//
// Generated by this command:
//
//	mockgen -package=mocks -source=/home/wil/dev/sro/connection-service/pkg/pb/connection_grpc.pb.go -destination=/home/wil/dev/sro/connection-service/pkg/mocks/connection_grpc.pb_mock.go
//
...
import (
	...
	pb "github.com/ShatteredRealms/connection-service/pkg/pb"
...
// VerifyConnectRequest mocks base method.
func (m *MockConnectionServiceClient) VerifyConnectRequest(ctx context.Context, in *pb.VerifyConnectRequestMessage, opts ...grpc.CallOption) (*pb.CharacterTarget, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "VerifyConnectRequest", varargs...)
	ret0, _ := ret[0].(*pb.CharacterTarget)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// VerifyConnectRequest indicates an expected call of VerifyConnectRequest.
func (mr *MockConnectionServiceClientMockRecorder) VerifyConnectRequest(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyConnectRequest", reflect.TypeOf((*MockConnectionServiceClient)(nil).VerifyConnectRequest), varargs...)
}
...
// VerifyConnectRequest mocks base method.
func (m *MockConnectionServiceServer) VerifyConnectRequest(arg0 context.Context, arg1 *pb.VerifyConnectRequestMessage) (*pb.CharacterTarget, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyConnectRequest", arg0, arg1)
	ret0, _ := ret[0].(*pb.CharacterTarget)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// VerifyConnectRequest indicates an expected call of VerifyConnectRequest.
func (mr *MockConnectionServiceServerMockRecorder) VerifyConnectRequest(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "VerifyConnectRequest", reflect.TypeOf((*MockConnectionServiceServer)(nil).VerifyConnectRequest), arg0, arg1)
}
